 ...
 * as a genuine {@code Currency} and refused by {@link Account}. Rejecting both here would leave the
 * domain's currency guard untested through the API.
 *
 * <p>Public only because the controllers now sit in their own package. Nothing outside
 * {@code controller} should call it.
 */
public final class MoneyRequests {
     ...
     */
    public static Money toMoney(BigDecimal amount, String currencyCode, Currency baseCurrency) {
